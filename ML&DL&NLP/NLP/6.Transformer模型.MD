...
## 七、`Transformer`案例实操——中英翻译case
1. 代码实例见(ML&DL&NLP/NLP/code&data/chap6/transformer)
2. 哈佛版本`Transformer`实现见`[3]``[4]`


-----
参考资料：
1. 视频教学：https://www.bilibili.com/video/BV1k44LzPEhU
2. 模型定义API：https://docs.pytorch.org/docs/stable/nn.html#transformer-layers
3. 哈佛版本实现网站：https://nlp.seas.harvard.edu/annotated-transformer/
4. 哈佛版本实现GIT：https://github.com/harvardnlp/annotated-transformer